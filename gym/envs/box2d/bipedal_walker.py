...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def step(self, action):
        # self.hull.ApplyForceToCenter((0, 20), True) -- Uncomment this to
        # receive a bit of stability help
        ...
        state = [
            ...
            # This will give 1.1 on high up, but it's still OK (and there
            # should be spikes on hiting the ground, that's normal too)
            self.joints[0].angle,
        ...
        # moving forward is a way to receive reward (normalized to get 300 on
        # completion)
        shaping = 130 * pos[0] / SCALE
        # keep head straight, other than that and falling, any behavior is
        # unpunished
        ...
        for a in action:
            ...
            # normalized to about -50.0 using heuristic, more optimal agent
            # should spend less
