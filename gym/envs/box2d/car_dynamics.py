    ...
    def step(self, dt):
        for w in self.wheels:
            ...
            w.omega += dt * ENGINE_POWER * w.gas / \
                WHEEL_MOMENT_OF_INERTIA / (abs(w.omega) + 5.0)
            ...
            # But dt is finite, that will lead to oscillations if difference is
            # already near zero.

            # Random coefficient to cut oscillations in few steps (have no
            # effect on friction_limit)
