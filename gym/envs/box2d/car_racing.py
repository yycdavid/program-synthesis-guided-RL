...
class CarRacing(gym.Env, EzPickle):
    ...
    def _create_track(self):
        ...
        # Find closed loop range i1..i2, first loop should be ignored, second
        # is OK
        i1, i2 = -1, -1
        i = len(track)
        while True:
        ...
        if self.verbose == 1:
            print(
                "Track generation: %i..%i -> %i-tiles track" %
                (i1, i2, i2 - i1))
        assert i1 != -1
        assert i2 != -1
    ...
    def render(self, mode="human"):
        ...
        self.transform.set_translation(WINDOW_W /
                                       2 -
                                       (scroll_x *
                                        zoom *
                                        math.cos(angle) -
