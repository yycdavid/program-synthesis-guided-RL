...
class KellyCoinflipEnv(gym.Env):
    ...
    def __init__(
        ...
        self.action_space = spaces.Discrete(
            int(max_wealth * 100))  # betting in penny
        # increments
...
class KellyCoinflipGeneralizedEnv(gym.Env):
    ...
    def __init__(
        ...
        # clip_distributions=True asserts that state and action space are not
        # modified at reset()
        ...
        self.wins = 0
        self.losses = 0
        # for the number of rounds, we need to remember how many rounds we've
        # played:
    ...
    def reset(self):
        ...
        # reproducibility and pass in the same hyper-parameters as originally
        # specified:
