...
register(
    id='Antg-v1',
    entry_point='gym.envs.mujoco:AntGoalEnv',
    max_episode_steps=50,
)
...
for reward_type in ['sparse', 'dense']:
    ...
    register(id='HandManipulateBlockRotateZTouchSensors{}-v0'.format(suffix),
    ...
    register(id='HandManipulateBlockRotateZTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandBlockTouchSensorsEnv',
             kwargs=_merge({'target_position': 'ignore',
                            'target_rotation': 'z',
    ...
    register(id='HandManipulateBlockTouchSensors{}-v0'.format(suffix),
             entry_point='gym.envs.robotics:HandBlockTouchSensorsEnv',
    ...
    register(id='HandManipulateBlockTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandBlockTouchSensorsEnv',
             kwargs=_merge({'target_position': 'random',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'sensordata'},
    ...
    register(id='HandManipulateEggRotateTouchSensors{}-v0'.format(suffix),
    ...
    register(id='HandManipulateEggRotateTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandEggTouchSensorsEnv',
             kwargs=_merge({'target_position': 'ignore',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'sensordata'},
    ...
    register(id='HandManipulateEggTouchSensors{}-v0'.format(suffix),
             entry_point='gym.envs.robotics:HandEggTouchSensorsEnv',
             kwargs=_merge({'target_position': 'random',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'boolean'},
    ...
    register(id='HandManipulateEggTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandEggTouchSensorsEnv',
             kwargs=_merge({'target_position': 'random',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'sensordata'},
    ...
    register(id='HandManipulatePenRotateTouchSensors{}-v0'.format(suffix),
    ...
    register(id='HandManipulatePenRotateTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandPenTouchSensorsEnv',
             kwargs=_merge({'target_position': 'ignore',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'sensordata'},
    ...
    register(id='HandManipulatePenTouchSensors{}-v0'.format(suffix),
             entry_point='gym.envs.robotics:HandPenTouchSensorsEnv',
             kwargs=_merge({'target_position': 'random',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'boolean'},
    ...
    register(id='HandManipulatePenTouchSensors{}-v1'.format(suffix),
             entry_point='gym.envs.robotics:HandPenTouchSensorsEnv',
             kwargs=_merge({'target_position': 'random',
                            'target_rotation': 'xyz',
                            'touch_get_obs': 'sensordata'},
