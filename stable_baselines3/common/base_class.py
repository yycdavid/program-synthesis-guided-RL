...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        if env is not None:
            ...
            if self.use_sde and not isinstance(
    ...
    def _update_current_progress_remaining(
            self, num_timesteps: int, total_timesteps: int) -> None:
        """
    ...
    def _update_learning_rate(self,
                              optimizers: Union[List[th.optim.Optimizer],
    ...
    def _setup_learn(
        ...
        if self.ep_info_buffer is None or reset_num_timesteps:
            # Initialize buffers if they don't exist, or reinitialize if
            # resetting counters
        ...
        # Avoid resetting the environment when calling ``.learn()`` consecutive
        # times
    ...
    def _update_info_buffer(
            self, infos: List[Dict[str, Any]], dones: Optional[np.ndarray] = None) -> None:
        """
