...
def evaluate_policy(
    ...
    while len(episode_rewards) < n_eval_episodes:
        ...
        # Record final distance to goal
        final_dist = np.linalg.norm(obs[-2:])
    ...
    if return_episode_rewards:
        if with_dist:
            return episode_rewards, episode_lengths, final_dists, mean_reward, std_reward, mean_dist, std_dist
        else:
            return episode_rewards, episode_lengths

    if with_dist:
        return mean_reward, std_reward, mean_dist, std_dist
    else:
