...
class MlpExtractor(nn.Module):
    ...
    def __init__(
        ...
        # Create networks
        # If the list of layers is empty, the network will just act as an
        # Identity module
...
def get_actor_critic_arch(
        net_arch: Union[List[int], Dict[str, List[int]]]) -> Tuple[List[int], List[int]]:
    """
    ...
    if isinstance(net_arch, list):
        ...
        assert isinstance(
            net_arch, dict), "Error: the net_arch can only contain be a list of ints or a dict"
