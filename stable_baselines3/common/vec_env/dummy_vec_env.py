...
class DummyVecEnv(VecEnv):
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        return (
            self._obs_from_buf(), np.copy(
                self.buf_rews), np.copy(
                self.buf_dones), deepcopy(
                self.buf_infos))
    ...
    def env_method(
        ...
        return [
            getattr(
                ...
                *
                method_args,
                **method_kwargs) for env_i in target_envs]
    ...
    def env_is_wrapped(self,
        ...
        return [env_util.is_wrapped(env_i, wrapper_class)
                for env_i in target_envs]
